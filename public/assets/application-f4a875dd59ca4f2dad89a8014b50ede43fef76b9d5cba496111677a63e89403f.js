...
(function (factory) {
    ...
    $.extend(Gallery.prototype, {
        ...
        options: {
            ...
            clearSlides: true,
            // Defines if links should be stretched to fill the available space,
            // while maintaining their aspect ratio (will only be enabled for browsers
            // supporting background-size="contain", which excludes IE < 9).
            // Set to "cover", to make links cover all available space (requires
                ...
                callbackWrapper = function (event) {
                    if (!called) {
                        ...
                        if (!element.parentNode) {
                            ...
                            // cached links before the element could
                            // be added to the DOM:
